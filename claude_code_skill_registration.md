...
- [1. Skillを置く場所](#1-skillを置く場所)
- [2. 全プロジェクト共通で使う場合](#2-全プロジェクト共通で使う場合)
- [3. 特定プロジェクトだけで使う場合](#3-特定プロジェクトだけで使う場合)
- [4. 最小構成](#4-最小構成)
- [5. Skill名とフォルダ名](#5-skill名とフォルダ名)
- [6. おすすめのSKILL.md構成](#6-おすすめのskillmd構成)
- [7. description は特に重要](#7-description-は特に重要)
- [8. when_to_use を使う場合](#8-when_to_use-を使う場合)
- [9. 自動発火させたくないSkill](#9-自動発火させたくないskill)
- [10. Claude専用Skill](#10-claude専用skill)
- [11. 主な設定の違い](#11-主な設定の違い)
- [12. Skillフォルダには補助ファイルも置ける](#12-skillフォルダには補助ファイルも置ける)
- [13. CLAUDE.mdとの役割分担](#13-claudemdとの役割分担)
- [14. SkillへのルーティングをCLAUDE.mdに書く](#14-skillへのルーティングをclaudemdに書く)
- [15. Personal SkillとProject Skillの使い分け](#15-personal-skillとproject-skillの使い分け)
- [16. おすすめの実運用構成](#16-おすすめの実運用構成)
- [17. Skillを作る例](#17-skillを作る例)
- [18. 作成後の確認](#18-作成後の確認)
- [19. Skillの動作確認方法](#19-skillの動作確認方法)
- [20. Skillを増やすときの設計原則](#20-skillを増やすときの設計原則)
- [21. 最低限これだけ覚えればよい](#21-最低限これだけ覚えればよい)
- [22. まとめ](#22-まとめ)
