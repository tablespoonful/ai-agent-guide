...
- [2. CLAUDE.mdは「強制設定」ではない](#2-claudemdは強制設定ではない)
- [3. CLAUDE.mdは毎セッション読み込まれる](#3-claudemdは毎セッション読み込まれる)
- [4. CLAUDE.mdに向いている情報](#4-claudemdに向いている情報)
- [5. CLAUDE.mdに向いていない情報](#5-claudemdに向いていない情報)
- [6. CLAUDE.mdの基本構造](#6-claudemdの基本構造)
- [7. おすすめの全体構成](#7-おすすめの全体構成)
- [8. Project Overview](#8-project-overview)
- [9. Project Overviewに書きすぎない](#9-project-overviewに書きすぎない)
- [10. Repository Structure](#10-repository-structure)
- [11. Repository Structureの目的](#11-repository-structureの目的)
- [12. Architecture](#12-architecture)
- [13. Architectureには「禁止境界」も書く](#13-architectureには禁止境界も書く)
- [14. Commands](#14-commands)
- [15. コマンドは具体的に書く](#15-コマンドは具体的に書く)
- [16. Coding Rules](#16-coding-rules)
- [17. 曖昧なルールを避ける](#17-曖昧なルールを避ける)
- [18. Testing](#18-testing)
- [19. テストの「どこまで」を書く](#19-テストのどこまでを書く)
- [20. Verification](#20-verification)
- [21. Git / Change Policy](#21-git--change-policy)
- [22. Git操作について](#22-git操作について)
- [23. Security / Safety](#23-security--safety)
- [24. Safetyルールの限界](#24-safetyルールの限界)
- [25. Skill Routing](#25-skill-routing)
- [26. CLAUDE.mdにSkill本文を書かない](#26-claudemdにskill本文を書かない)
- [27. Do Not](#27-do-not)
- [28. References](#28-references)
- [29. @import の仕組み](#29-import-の仕組み)
- [30. 相対パスの基準](#30-相対パスの基準)
- [31. importは再帰可能](#31-importは再帰可能)
- [32. @を文字として書きたい場合](#32-を文字として書きたい場合)
- [33. importはコンテキスト節約にはならない](#33-importはコンテキスト節約にはならない)
- [34. 長い情報はSkillまたはRulesへ](#34-長い情報はskillまたはrulesへ)
- [35. AGENTS.mdとの関係](#35-agentsmdとの関係)
- [36. CLAUDE.mdをsymlinkにする方法](#36-claudemdをsymlinkにする方法)
- [37. .claude/rules/との使い分け](#37-clauderulesとの使い分け)
- [38. Rulesの役割](#38-rulesの役割)
- [39. Path-specific Rules](#39-path-specific-rules)
- [40. Rulesに向いている内容](#40-rulesに向いている内容)
- [41. Skillとの違い](#41-skillとの違い)
- [42. CLAUDE.local.md](#42-claudelocalmd)
- [43. CLAUDE.local.mdはGit管理しない](#43-claudelocalmdはgit管理しない)
- [44. User-level CLAUDE.md](#44-user-level-claudemd)
- [45. User-levelにProject固有ルールを書かない](#45-user-levelにproject固有ルールを書かない)
- [46. Managed / Organization CLAUDE.md](#46-managed--organization-claudemd)
- [47. 読み込みスコープ](#47-読み込みスコープ)
- [48. 同じdirectoryではLocalが後](#48-同じdirectoryではlocalが後)
- [49. Nested CLAUDE.md](#49-nested-claudemd)
- [50. 下位CLAUDE.mdはlazy load](#50-下位claudemdはlazy-load)
- [51. CLAUDE.mdの推奨サイズ](#51-claudemdの推奨サイズ)
- [52. 200行は絶対制限ではない](#52-200行は絶対制限ではない)
- [53. 長くなったときの分割優先順位](#53-長くなったときの分割優先順位)
- [54. HTMLコメントはcontextから除去される](#54-htmlコメントはcontextから除去される)
- [55. HTMLコメントの用途](#55-htmlコメントの用途)
- [56. /init](#56-init)
- [57. /init任せにしすぎない](#57-init任せにしすぎない)
- [58. /context](#58-context)
- [59. /memory](#59-memory)
- [60. CLAUDE.mdとAuto Memory](#60-claudemdとauto-memory)
- [61. Auto Memoryと重複させない](#61-auto-memoryと重複させない)
- [62. CLAUDE.mdとSettingsの違い](#62-claudemdとsettingsの違い)
- [63. CLAUDE.mdとHooksの違い](#63-claudemdとhooksの違い)
- [64. CLAUDE.mdとSkillの違い](#64-claudemdとskillの違い)
- [65. CLAUDE.mdとRulesの違い](#65-claudemdとrulesの違い)
- [66. CLAUDE.mdを「ルーター」にする設計](#66-claudemdをルーターにする設計)
- [67. 推奨構成：小規模project](#67-推奨構成小規模project)
- [68. 推奨構成：中規模project](#68-推奨構成中規模project)
- [69. 推奨構成：モノレポ](#69-推奨構成モノレポ)
- [70. 良いCLAUDE.md例](#70-良いclaudemd例)
- [71. 悪いCLAUDE.md例](#71-悪いclaudemd例)
- [72. 改善版](#72-改善版)
- [73. 矛盾するルールを作らない](#73-矛盾するルールを作らない)
- [74. 優先度を文章で表現する場合](#74-優先度を文章で表現する場合)
- [75. 一時的なタスクを書かない](#75-一時的なタスクを書かない)
- [76. 秘密情報を書かない](#76-秘密情報を書かない)
- [77. 実装詳細を重複させない](#77-実装詳細を重複させない)
- [78. CLAUDE.mdを自己更新させる場合の注意](#78-claudemdを自己更新させる場合の注意)
- [79. CLAUDE.mdへ追加する判断基準](#79-claudemdへ追加する判断基準)
- [80. 追加しない方がよい判断基準](#80-追加しない方がよい判断基準)
- [81. 推奨テンプレート：汎用](#81-推奨テンプレート汎用)
- [82. 推奨テンプレート：AI Agent重視](#82-推奨テンプレートai-agent重視)
- [83. 推奨テンプレート：ロボティクス / ROS2](#83-推奨テンプレートロボティクス--ros2)
- [84. 推奨テンプレート：Web Application](#84-推奨テンプレートweb-application)
- [85. CLAUDE.mdを作る順番](#85-claudemdを作る順番)
- [86. CLAUDE.md評価方法](#86-claudemd評価方法)
- [87. CLAUDE.mdあり / なしで比較する](#87-claudemdあり--なしで比較する)
- [88. CLAUDE.mdは「量」ではなく「情報密度」](#88-claudemdは量ではなく情報密度)
- [89. 「全部Claudeに覚えさせる」は逆効果](#89-全部claudeに覚えさせるは逆効果)
- [90. 最も重要な設計原則](#90-最も重要な設計原則)
- [91. CLAUDE.md・Rules・Skills・Hooksの役割分担](#91-claudemdrulesskillshooksの役割分担)
- [92. 最終チェックリスト](#92-最終チェックリスト)
- [93. まとめ](#93-まとめ)
- [参考資料](#参考資料)
